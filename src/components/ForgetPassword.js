...
const ForgetPassword = ({ setIsForgetPass }) => {
    return (
        <Box w={"100%"} h={"100%"}>
            ...
            <Box>
                <Text style={{ textAlign: "center", color: "black" }}>Back to Login ? <Text onPress={() => { setIsForgetPass(false) }} style={{ textAlign: "center", color: "black", fontWeight: "bold" }} >Click Here</Text></Text>
            </Box>
