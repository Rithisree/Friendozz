...
const PostPage = () => {
  return (
    <Box w={"100%"} h={"100%"}>
        ...
        <Box w={"100%"} h={"85%"} style={{display:"flex",flexDirection:"row",  justifyContent:"space-between"}}>
            <Box w={"88%"} style={{marginLeft:3}}>
                <Box w={"100%"} h={"60%"}>
                    <Box h={"14%"} style={{backgroundColor:"white", display:"flex", flexDirection:"row", alignItems:"center", justifyContent:"space-between"}}>
                        <Image 
                            style={{marginLeft:8}}
                    ...
                    <Box h={"86%"} style={{backgroundColor:"grey"}}>

                    </Box>
                </Box>
                <Box style={{display:"flex", flexDirection:"row", alignItems:"center", justifyContent:"space-between", marginLeft: 5, marginRight:5}}>
                    <Image
            ...
            <Box w={"12%"} h={"100%"} style={{borderLeftWidth:1, borderLeftColor:"#D9D9D9", display:"flex", alignItems:"center"}}>
        ...
        <Box h={"8%"} style={{borderTopWidth:1, borderTopColor:"#D9D9D9", display:"flex", flexDirection:"row", alignItems:"center", justifyContent:"space-around"}}>
            <Image
