...
const PostPage = () => {
  return (
    <Box w={"100%"} h={"100%"} style={{display:"flex", flexDirection:"column"}}>
        ...
        <Box w={"100%"} h={"85%"} style={{display:"flex", overflow:"scroll"}}>
            <Box w={"100%"} h={"60%"} style={{display:"flex",flexDirection:"row",  justifyContent:"space-between"}}>
                <Box w={"88%"} h={"100%"} style={{marginLeft:3}}>
                    <Box w={"100%"} h={"100%"}>
            ...
            <Box w={"100%"} h={"60%"} style={{marginTop:40, display:"flex",flexDirection:"row",  justifyContent:"space-between"}}>
                <Box w={"88%"} h={"100%"} style={{marginLeft:3}}>
                    <Box w={"100%"} h={"100%"}>
                        <Box h={"14%"} style={{backgroundColor:"white", display:"flex", flexDirection:"row", alignItems:"center", justifyContent:"space-between"}}>
                            <Image 
