...
const SignIn = ({navigation}) => {
  ...
  return(
    <Box w={"100%"} h={"100%"}>
        ...
        {selectedTab===0?(
          <Box style={{margin:18}}>
            <Text>Enter a valid Phone number and password to set your account</Text>
            <Text>If You have an account,<Text onPress={()=>navigation.navigate("LoginScreen")} style={{color:"black"}}>Login</Text></Text>
            ...
            <Box style={{margin:18}}>
            <Text>Enter a valid E-Mail Id and password to set your account</Text>
            <Text>If You have an account,<Text onPress={()=>navigation.navigate("LoginScreen")} style={{color:"black"}}>Login</Text></Text>
            <Box style={{marginBottom:25, marginTop:40, display:"flex", flexDirection:"row", alignItems:"center", justifyContent:"space-between"}}>
              <Box>
                <Text style={{color:"black", fontSize:18}}>First Name</Text>
        ...
        <Box style={{marginTop:200, marginLeft:230, backgroundColor:"#009DF5", height: 40, width: 140, display:"flex", alignItems:"center", justifyContent:"center", borderRadius:10}}>
